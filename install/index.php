            ...
            <div class="section">
                ...
                <div class="form">
                    ...
                    <div class="mdui-textfield mdui-textfield-not-empty">
                        ...
                        <input class="mdui-textfield-input" name="dbname" value="shortlink">
                    </div>
                    <div class="mdui-textfield mdui-textfield-not-empty">
                        <label class="mdui-textfield-label">用户名</label>
                        <input class="mdui-textfield-input" name="dbuser" value="shortlink">
                    </div>
                    ...
                    <div class="mdui-textfield mdui-textfield-not-empty mdui-textfield-has-bottom">
                        ...
                        <input class="mdui-textfield-input" name="dbprefix" value="sl_" autocomplete="off">
                        <div class="mdui-textfield-helper">如果您希望在同一个数据库安装多个ShortLink | 短链接, 请修改前缀</div>
                    </div>
                </div>
            </div>
            <div class="section">
